...
def create_GoC( runid, usefile='cellparams_file.pkl', morpho_fname='GoC.cell.nml', has2Pools=False, girk=False ):
	"""
	...
	has2Pools:  whether morphology file is of class Cell2CaPools (if False, assumes it is Cell)
	...
	if girk:
		gocID = 'GoC_wGIRK_'+format(runid, '05d')
	else:
