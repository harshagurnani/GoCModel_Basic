...
def create_GoC_network( duration=1000, dt=0.025, seed=100, runid=0, hom=True, run=False, goc_fileid='GoC_2Pools_', dend_id = [3,4,5,6,7,8] ):
	"""
...
def get_params( runid=0, hom=False, nGJ_dend=6 ):
	...
	params = inp.get_simulation_params( runid, nInputs_max=nInputs_max, nInputs_frac=nInputs_frac, nGoC_pop = nPop, Input_prob=Input_prob, nGJ_dend=nGJ_dend )
	return params
